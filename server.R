...
p2 <- readRDS("www/p.rds")
GPR17 <- readRDS("www/GPR17.RDS")
textm <- read.csv("www/Supplymentary table 1.csv")
#write.csv(textm,file = "Supplymentary table 1.csv")
diff <- read.csv("www/Supplymentary table 4.csv")
